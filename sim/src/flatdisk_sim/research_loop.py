    ...
    return {
        ...
        "TrainingReadiness": {
            ...
            "fields": {
                ...
                "qwenToolTrainingManifestCount": "number",
                ...
                "qwenGrpoTrainingManifestCount": "number",
                "qwenGrpoGroupCount": "number",
                "qwenGrpoTrainableGroupCount": "number",
                "qwenGrpoCandidateCount": "number",
                "qwenGrpoTrainableCandidateCount": "number",
                "qwenGrpoStepSampleCount": "number",
                "qwenPpoStepSampleCount": "number",
                "qwenGrpoMissingImageCount": "number",
                "grpoEligibleSampleCount": "number",
                "missingRequiredArtifacts": ["string"],
                "forbiddenPolicySampleTokenHits": ["string"],
                "forbiddenQwenMessageTokenHits": ["string"],
                "forbiddenQwenGrpoMessageTokenHits": ["string"],
                "qwenGrpoBlockers": ["string"],
                "blockers": ["string"],
                "warnings": ["string"],
                "reportPath": "string",
                "markdownPath": "string",
